    ...
    heading: (
      <div className="mb-2">
        <h2 className="text-4xl lg:text-5xl font-bold leading-tight bg-gradient-to-b from-white via-zinc-900 to-black dark:from-zinc-900 dark:via-white dark:to-white bg-clip-text text-transparent">
          ...
          <div
            className={`inline-block w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-full overflow-hidden border-4 ${heroData.images.tech.borderColor} mx-2 align-middle`}
          >
            <img
    ...
    heading: (
      <div className="mb-5">
        <h3 className="text-4xl lg:text-5xl font-bold leading-tight bg-gradient-to-b from-white via-zinc-900 to-black dark:from-zinc-900 dark:via-white dark:to-white bg-clip-text text-transparent">
          ...
          <div
            className={`inline-block w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24 rounded-full overflow-hidden border-4 ${heroData.images.location.borderColor} ml-2 align-middle`}
          >
            <img
