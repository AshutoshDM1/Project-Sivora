...
const projectsData: Project[] = [
  {
    ...
    techstack:
      'Next.js, Tailwind CSS , Framer Motion, Zustand, Express.js, PostgreSQL , Gemmini API , Realtime Streaming, AWS, Github Actions, Vercel',
    image:
      'https://res.cloudinary.com/dnvl8mqba/image/upload/v1752063831/Portfolio%C2%A0Pics%C2%A0/image6_vr7b8q.png',
  ...
  },
  {
    ...
    techstack:
      'Next.js, Tailwind CSS, Shadcn UI, Recoil, Framer Motion ,Next.js API Routes, NextAuth, Prisma, PostgreSQL, Docker, AWS, Github Actions, Cloudinary',
    image:
      'https://res.cloudinary.com/dnvl8mqba/image/upload/v1752063830/Portfolio%C2%A0Pics%C2%A0/image1_r77d9w.png',
  ...
  },
  {
    ...
    techstack:
      'React, TypeScript, Recoil, Tailwind CSS, FireBase, Hono, TypeScript, Gemmini API , Docker , Cloudflare Workers',
    image:
      'https://res.cloudinary.com/dnvl8mqba/image/upload/v1752063832/Portfolio%C2%A0Pics%C2%A0/image2_gpqog9.png',
...
const Projects = () => {
  ...
  const element = [
    {
      heading: <h2 className="text-4xl md:text-5xl font-bold  mb-6">My Projects</h2>,
    },
    {
      heading: (
    ...
    <section className="pt-32 pb-16 px-4 max-w-7xl mx-auto">
      ...
      <div className="text-center mb-10">
        {element.map((element, index) => (
          <BlurFade inView={true} key={index} delay={1.7 + index * 0.2}>
            {element.heading}
          </BlurFade>
        ))}
      </div>
      ...
      <div className="flex justify-center flex-wrap lg:flex-nowrap gap-8">
        {projectsData.map((project, index) => (
          <BlurFade inView={true} key={index} delay={2 + index * 0.2}>
            <Card
              key={project.id}
              className="rounded-2xl border-transparent dark:border-zinc-800 overflow-hidden transition-all duration-300 group py-0 min-w-[15rem] xl:min-w-[25rem] max-w-[25rem] bg-background cursor-pointer"
            >
                ...
                <div className="px-6 pb-4">
                  ...
                  <div className="flex items-center gap-[-2px] mb-4">
                    {getMainTechnologies(project).map((tech, index) => (
                      ...
                      >
                        <div
                          className={`w-5 h-5 flex items-center justify-center ${getTechColor(tech)} overflow-hidden`}
                        >
